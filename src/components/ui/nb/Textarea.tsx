  ...
  ({ error, label, errorMessage, className, id, ...props }, ref) => {
    ...
    return (
      <div className="flex flex-col gap-1">
        {label && (
          <label htmlFor={textareaId} className="text-[11px] font-[600] text-nb-muted uppercase tracking-[0.04em]">
            {label}
          </label>
        )}
        <textarea
          ...
          className={cn(
            ...
            'focus:outline-none focus:border-nb-green transition-colors duration-150 resize-y min-h-[80px]',
...
Textarea.displayName = 'NbTextarea'
